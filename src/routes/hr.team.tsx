...
export const Route = createFileRoute("/hr/team")({
  component: () => (
    <RequireRole allow={["hr"]}><TeamView /></RequireRole>
  ),
});
...
function TeamView() {
  ...
  if (!teams) return <MobileShell title="Teams"><div className="py-8 flex justify-center"><Loader2 className="h-5 w-5 animate-spin text-muted-foreground" /></div></MobileShell>;
